<div class="specials index">
	...
	<tr>
		...
		<td><?php echo h($special['Special']['name']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $special['Special']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $special['Special']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
